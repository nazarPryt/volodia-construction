...
const qualifications = [
  {
    ...
    title: 'Освіта',
    description:
      'Будівельний коледж за спеціальністю "Оздоблювальні роботи". Регулярно проходжу курси підвищення кваліфікації.',
  },
  {
    icon: '🔧',
    title: 'Спеціалізація',
  ...
  },
  {
    icon: '🤝',
    title: 'Гарантія',
    description: 'Надаю письмову гарантію на всі види робіт. Завжди на звязку навіть після завершення ремонту.',
  },
]
